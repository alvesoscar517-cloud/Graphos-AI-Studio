  ...
  return (
    <form className="w-full" onSubmit={handleSubmit}>
      <div className="text-center mb-4 sm:mb-5">
        ...
        <h3 className="m-0 mb-1 text-lg sm:text-xl font-semibold text-gray-900">{t('auth.getStarted')}</h3>
        <p className="m-0 text-xs sm:text-sm text-gray-500">{t('auth.email.registerSubtitle', 'Create your account to get started')}</p>
      </div>

      {/* Name Field */}
      <div className="mb-3 sm:mb-3.5 text-left">
        <label htmlFor="displayName" className="block mb-1 sm:mb-1.5 text-xs sm:text-sm font-medium text-gray-600">
        ...
        {errors.displayName && (
          <span className="text-[10px] sm:text-xs text-red-500 mt-1 block">{errors.displayName.message}</span>
        )}
      </div>

      {/* Email Field */}
      <div className="mb-3 sm:mb-3.5 text-left">
        <label htmlFor="registerEmail" className="block mb-1 sm:mb-1.5 text-xs sm:text-sm font-medium text-gray-600">
      ...
      {/* Password Field */}
      <div className="mb-3 sm:mb-3.5 text-left">
        <label htmlFor="registerPassword" className="block mb-1 sm:mb-1.5 text-xs sm:text-sm font-medium text-gray-600">
        ...
        {errors.password && (
          <span className="text-[10px] sm:text-xs text-red-500 mt-1 block">{errors.password.message}</span>
        )}
        {/* Strength Bar */}
        <div className="min-h-[20px] sm:min-h-[24px] mt-2 sm:mt-2.5">
          {password && (
            <div className="flex items-center gap-2 sm:gap-2.5">
              ...
              <span className={cn("text-[10px] sm:text-2xs font-semibold uppercase tracking-wide min-w-[50px] sm:min-w-[60px] text-right", strengthTextColors[passwordStrength.level])}>
      ...
      {/* Confirm Password */}
      <div className="mb-3 sm:mb-3.5 text-left">
        <label htmlFor="confirmPassword" className="block mb-1 sm:mb-1.5 text-xs sm:text-sm font-medium text-gray-600">
      ...
      <div className="flex items-center gap-2 sm:gap-3 my-3 sm:my-4">
        ...
        <span className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider font-medium">{t('auth.email.or')}</span>
        <div className="flex-1 h-px bg-gray-200" />
      </div>
