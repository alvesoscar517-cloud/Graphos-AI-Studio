 ...
 * Shows current auth method, Google linking options, and security settings
 */
const AccountSettings = () => {
  const { t } = useTranslation()
  const [activeSection, setActiveSection] = useState('account') // account, security
  const { 
    user, 
    authMethod, 
    hasGoogleLinked,
  ...
  return (
    <div className="account-settings">
      ...
      <div className="account-tabs">
        <button 
          className={`account-tab ${activeSection === 'account' ? 'active' : ''}`}
