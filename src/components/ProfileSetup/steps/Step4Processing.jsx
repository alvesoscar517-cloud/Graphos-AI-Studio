 ...
 * Updated: 2-column layout to match Step 1-3
 */
...
const ErrorView = ({ animationKey, errorMessage, errorCode, onBack, onRetry, t }) => {
  // Check if this is a credit-related error that shouldn't show retry
...
const Step4Processing = ({ animationKey, processing, processingStep, processingMessage, showCompletion, showError, errorMessage, errorCode, qualityScore, totalSamples, onBack, onRetry, onComplete }) => {
