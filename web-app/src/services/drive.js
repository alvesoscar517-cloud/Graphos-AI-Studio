...
async function getGoogleAccessToken() {
  // Web app: Use driveWeb module
  if (isWebApp()) {
    return getGoogleAccessTokenWeb()
  }
...
export async function requestGoogleAuth() {
  ...
  if (!isChromeExtension() || !chrome.identity?.getAuthToken) {
...
export async function getOrCreateAppFolder() {
  // Web app: Use driveWeb module
  if (isWebApp()) {
    return getOrCreateAppFolderWeb()
  }
...
export async function getOrCreateConversationsFolder() {
  // Web app: Use driveWeb module
  if (isWebApp()) {
    return getOrCreateConversationsFolderWeb()
  }
