/**
 * Rewrite - SEO-optimized AI Rewrite feature page
...
const TransformationBackground = () => (
  <div className="absolute inset-0 overflow-hidden -z-10">
    ...
    {/* SVG Transformation Visualization - Responsive sizing */}
    <svg 
      className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] sm:w-[700px] md:w-[850px] lg:w-[1000px] xl:w-[1100px] h-[400px] sm:h-[560px] md:h-[680px] lg:h-[800px] xl:h-[900px] opacity-100"
    ...
    {/* Ambient glow - emerald - Responsive */}
    <div 
      className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[450px] md:w-[550px] lg:w-[650px] xl:w-[700px] h-[300px] sm:h-[450px] md:h-[550px] lg:h-[650px] xl:h-[700px] pointer-events-none"
      style={{
    ...
    <div 
      className="absolute top-1/3 right-1/4 w-[150px] sm:w-[200px] md:w-[250px] lg:w-[300px] h-[200px] sm:h-[280px] md:h-[340px] lg:h-[400px] pointer-events-none"
      style={{
  ...
  return (
    ...
    >
      <div className="relative px-3 py-2.5 sm:px-4 sm:py-3 md:px-6 md:py-4 bg-white/60 dark:bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/50 dark:border-white/10 shadow-lg shadow-black/5">
        <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-br from-emerald-500/20 to-green-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-xl" />
        
        <div className="text-center">
          <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-600 bg-clip-text text-transparent">
            {displayValue}
          </div>
...
const TransformationShowcase = ({ t }) => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-28 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-[10%] w-48 sm:w-64 md:w-80 h-48 sm:h-64 md:h-80 bg-emerald-400/20 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-[10%] w-56 sm:w-72 md:w-96 h-56 sm:h-72 md:h-96 bg-green-400/15 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative">
        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <motion.span 
            ...
            viewport={{ once: true }} 
            className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-emerald-500 to-green-500 text-white text-xs sm:text-sm font-semibold rounded-full mb-3 sm:mb-4 shadow-lg shadow-emerald-500/20"
          >
        ...
        {/* Style selector tabs - Responsive */}
        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="relative">
            <div className="absolute -top-2 sm:-top-3 left-3 sm:left-4 z-10">
              <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gray-500 text-white text-[10px] sm:text-xs font-semibold rounded-full">
                BEFORE
              </span>
            </div>
            <div className="min-h-[140px] sm:min-h-[160px] md:min-h-[180px] p-4 sm:p-5 md:p-6 bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-slate-700 shadow-lg">
          ...
          <div className="relative">
            <div className="absolute -top-2 sm:-top-3 left-3 sm:left-4 z-10">
              <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-emerald-500 to-green-500 text-white text-[10px] sm:text-xs font-semibold rounded-full shadow-lg shadow-emerald-500/30">
                AFTER
              </span>
            </div>
            <div className="min-h-[140px] sm:min-h-[160px] md:min-h-[180px] p-4 sm:p-5 md:p-6 bg-emerald-50 dark:bg-emerald-500/10 rounded-xl sm:rounded-2xl border-2 border-emerald-200 dark:border-emerald-500/30 shadow-lg">
              {showAfter ? (
                <div>
                  ...
                  <div className="mt-3 sm:mt-4">
                    <span className={`inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm font-semibold ${
                ...
                <div className="flex items-center justify-center h-full min-h-[100px] sm:min-h-[120px]">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <motion.div
                      animate={{ rotate: 360 }}
                      transition={{ duration: 1, repeat: Infinity, ease: 'linear' }}
                      className="w-5 h-5 sm:w-6 sm:h-6 border-2 border-emerald-200 border-t-emerald-500 rounded-full"
                    />
                    <span className="text-emerald-600 dark:text-emerald-400 text-xs sm:text-sm font-medium">{t('demo.transforming', 'Transforming...')}</span>
                  </div>
                </div>
              )}
            </div>
        ...
        <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 translate-y-16 z-20">
          <motion.div
            ...
            className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-emerald-500 to-green-500 rounded-full flex items-center justify-center shadow-xl shadow-emerald-500/40"
          >
        ...
        >
          <a 
            href="#demo" 
            className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-emerald-500 to-green-500 text-white rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 transition-all"
          >
...
const UseCasesSection = ({ t, useCases }) => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-28 overflow-hidden bg-bg-secondary relative">
      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 relative">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="relative"
          >
            <div className="relative bg-gradient-to-br from-emerald-50 via-green-50/50 to-white dark:from-slate-800 dark:via-emerald-900/20 dark:to-slate-900 rounded-2xl sm:rounded-3xl border border-emerald-200/50 dark:border-emerald-500/20 overflow-hidden">
              <div className="absolute top-0 right-0 w-32 sm:w-48 md:w-64 h-32 sm:h-48 md:h-64 bg-gradient-to-bl from-emerald-200/30 to-transparent rounded-full blur-3xl pointer-events-none" />
                ...
                <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 items-center">
                  ...
                  <div>
                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                      <motion.div 
                        ...
                        className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-emerald-400 to-green-500 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-xl shadow-emerald-500/30"
                      >
                    ...
                    <div className="inline-flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-1.5 sm:py-2 bg-white dark:bg-slate-700 rounded-lg sm:rounded-xl border border-emerald-200 dark:border-emerald-500/30 shadow-sm">
                      ...
                      <span className="text-base sm:text-lg font-bold bg-gradient-to-r from-emerald-500 to-green-500 bg-clip-text text-transparent">
                  ...
                  <div className="relative">
                    ...
                    <motion.div
                      ...
                      className="absolute -top-2 -right-2 sm:-top-3 sm:-right-3 px-2 sm:px-3 py-1 sm:py-1.5 bg-gradient-to-r from-emerald-500 to-green-500 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg"
                    >
                      {extendedUseCases[selectedCase].stats.value}
                    </motion.div>
                  </div>
                  ...
                  {extendedUseCases.map((_, index) => (
                    <button
                      ...
                      className={`
                        ...
                        ${selectedCase === index 
                          ? 'w-6 sm:w-8 bg-gradient-to-r from-emerald-500 to-green-500' 
...
const HowItWorksSection = ({ t, howItWorks }) => {
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-28 bg-bg-secondary relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-48 sm:w-64 md:w-80 lg:w-96 h-48 sm:h-64 md:h-80 lg:h-96 bg-emerald-500/5 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-1/4 w-40 sm:w-56 md:w-72 lg:w-80 h-40 sm:h-56 md:h-72 lg:h-80 bg-green-500/5 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative">
        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-16">
          <motion.span 
            ...
            whileInView={{ opacity: 1, scale: 1 }} 
            viewport={{ once: true }} 
            className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white dark:bg-slate-800 text-emerald-600 dark:text-emerald-400 text-xs sm:text-sm font-semibold rounded-full mb-3 sm:mb-4 border border-emerald-200 dark:border-emerald-500/30 shadow-sm"
          >
        ...
        {/* Steps - Horizontal Cards - Responsive */}
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 lg:gap-8">
          {howItWorks.map((item, index) => (
            ...
            >
              ...
              {/* Card - Responsive */}
              <div className="relative bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-gray-200 dark:border-slate-700 shadow-lg hover:shadow-xl transition-shadow h-full">
                {/* Step number badge - Responsive */}
                <div className="absolute -top-3 sm:-top-4 left-4 sm:left-6">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-emerald-500 to-green-500 rounded-full flex items-center justify-center shadow-lg shadow-emerald-500/30">
                ...
                <div className="mt-3 sm:mt-4 mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-emerald-100 dark:bg-emerald-500/20 rounded-lg sm:rounded-xl flex items-center justify-center">
                    <Icon name={item.icon} size="lg" className="icon-emerald sm:hidden" />
                    <Icon name={item.icon} size="xl" className="icon-emerald hidden sm:block" />
                  </div>
                </div>
                
                {/* Content - Responsive */}
                <h3 className="text-base sm:text-lg font-semibold text-text-primary mb-1.5 sm:mb-2">{item.title}</h3>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-8 sm:mt-10 md:mt-12 p-4 sm:p-5 md:p-6 bg-gradient-to-r from-emerald-500 to-green-500 rounded-xl sm:rounded-2xl shadow-xl shadow-emerald-500/20"
        >
            ...
            {[
              ...
              <div key={i} className="text-center">
                <div className="flex items-center justify-center gap-1 sm:gap-2 mb-0.5 sm:mb-1">
                  <Icon name={stat.icon} size="md" className="icon-white sm:hidden" />
                  <Icon name={stat.icon} size="lg" className="icon-white hidden sm:block" />
                  <span className="text-lg sm:text-2xl md:text-3xl font-bold text-white">{stat.value}</span>
                </div>
                <div className="text-[10px] sm:text-xs md:text-sm text-white/80 whitespace-nowrap">{stat.label}</div>
              </div>
            ))}
          </div>
        </motion.div>
      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <motion.span 
            ...
            whileInView={{ opacity: 1, scale: 1 }} 
            viewport={{ once: true }} 
            className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white text-emerald-600 text-xs sm:text-sm font-semibold rounded-full mb-3 sm:mb-4 border border-gray-200 shadow-sm"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="group relative p-4 sm:p-5 md:p-6 bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-xl transition-all"
            >
              <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-br from-emerald-500/10 to-green-500/10 opacity-0 group-hover:opacity-100 transition-opacity" />
              
              <div className="relative">
                <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-emerald-100 dark:bg-emerald-500/20 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4 transition-colors">
                  <Icon name={benefit.icon} size="md" className="icon-emerald sm:hidden" />
                  <Icon name={benefit.icon} size="lg" className="icon-emerald hidden sm:block" />
                </div>
                <h3 className="text-sm sm:text-base font-semibold text-text-primary mb-1.5 sm:mb-2">{benefit.title}</h3>
                <p className="text-xs sm:text-sm text-text-secondary">{benefit.description}</p>
              </div>
            </motion.div>
          ))}
        </div>
...
const VoiceProfileIntegration = ({ t }) => {
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-28 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 left-1/4 w-48 sm:w-64 md:w-80 lg:w-96 h-48 sm:h-64 md:h-80 lg:h-96 bg-emerald-500/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 right-1/4 w-40 sm:w-56 md:w-72 lg:w-80 h-40 sm:h-56 md:h-72 lg:h-80 bg-indigo-500/5 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <p className="text-sm sm:text-base md:text-lg text-text-secondary mb-4 sm:mb-6 leading-relaxed">
            ...
            <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
              {[
                ...
                >
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-emerald-100 dark:bg-emerald-500/20 rounded-md sm:rounded-lg flex items-center justify-center flex-shrink-0">
                    <Icon name={item.icon} size="sm" className="icon-emerald" />
                  </div>
                  <span className="text-sm sm:text-base text-text-secondary">{item.text}</span>
                </motion.li>
              ))}
            </ul>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a 
                ...
                className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base shadow-lg shadow-emerald-500/20 hover:shadow-xl hover:shadow-emerald-500/30 transition-all"
              >
              ...
              <a 
                href="#demo"
                className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-white dark:bg-slate-800 text-text-primary rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base border border-gray-200 dark:border-slate-700 hover:border-emerald-300 transition-all"
              >
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative bg-gradient-to-br from-emerald-50 via-green-50/50 to-white dark:from-slate-800 dark:via-emerald-900/20 dark:to-slate-900 rounded-2xl sm:rounded-3xl border border-emerald-200/50 dark:border-emerald-500/20 p-4 sm:p-6 md:p-8 overflow-hidden">
              {/* Decorative background elements - Responsive */}
              <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -top-6 -right-6 sm:-top-10 sm:-right-10 w-24 sm:w-32 md:w-40 h-24 sm:h-32 md:h-40 bg-emerald-200/30 dark:bg-emerald-500/10 rounded-full blur-3xl" />
                <div className="absolute -bottom-6 -left-6 sm:-bottom-10 sm:-left-10 w-24 sm:w-32 md:w-40 h-24 sm:h-32 md:h-40 bg-teal-200/30 dark:bg-teal-500/10 rounded-full blur-3xl" />
              </div>
              
              {/* Connection visualization - Responsive */}
              <div className="relative flex items-center justify-center gap-4 sm:gap-6 md:gap-10">
                ...
                <div className="flex-1 relative h-8 sm:h-10 md:h-12 flex items-center">
                  <div className="w-full h-1 sm:h-1.5 bg-gradient-to-r from-emerald-400 via-teal-400 to-emerald-500 rounded-full opacity-30" />
                  {/* Animated dot 1 */}
                  <motion.div
                    animate={{ x: ['0%', '100%'], opacity: [0, 1, 1, 0] }}
                    transition={{ duration: 2, repeat: Infinity, ease: 'linear' }}
                    className="absolute left-0 w-2 h-2 sm:w-3 sm:h-3 bg-emerald-500 rounded-full shadow-lg shadow-emerald-500/50"
                  />
                  {/* Animated dot 2 */}
                  <motion.div
                    animate={{ x: ['0%', '100%'], opacity: [0, 1, 1, 0] }}
                    transition={{ duration: 2, repeat: Infinity, ease: 'linear', delay: 0.7 }}
                    className="absolute left-0 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-teal-400 rounded-full shadow-lg shadow-teal-400/50"
                  />
                  {/* Animated dot 3 */}
                  <motion.div
                    animate={{ x: ['0%', '100%'], opacity: [0, 1, 1, 0] }}
                    transition={{ duration: 2, repeat: Infinity, ease: 'linear', delay: 1.4 }}
                    className="absolute left-0 w-2 h-2 sm:w-2.5 sm:h-2.5 bg-green-500 rounded-full shadow-lg shadow-green-500/50"
                  />
                </div>
              ...
              {/* Result preview - Responsive */}
              <motion.div 
                initial={{ opacity: 0, y: 10 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: 0.3 }}
                className="relative mt-4 sm:mt-6 md:mt-8 p-3 sm:p-4 bg-white/80 dark:bg-slate-700/80 backdrop-blur-sm rounded-lg sm:rounded-xl border border-emerald-200/50 dark:border-emerald-500/20"
              >
                <div className="flex items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 bg-emerald-100 dark:bg-emerald-500/20 rounded-full flex items-center justify-center">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <motion.span 
            ...
            whileInView={{ opacity: 1, scale: 1 }} 
            viewport={{ once: true }} 
            className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-bg-primary text-emerald-600 text-xs sm:text-sm font-semibold rounded-full mb-3 sm:mb-4 border border-gray-200 dark:border-gray-700 shadow-sm"
          >
        ...
        >
          <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mx-auto mb-3 sm:mb-4 bg-emerald-500/10 rounded-lg sm:rounded-xl flex items-center justify-center">
            <Icon name="message-circle" size="lg" className="icon-emerald sm:hidden" />
            <Icon name="message-circle" size="xl" className="icon-emerald hidden sm:block" />
          </div>
          <h3 className="text-lg sm:text-xl font-bold text-text-primary mb-1.5 sm:mb-2">
            {t('faq.stillHaveQuestions', "Still have questions?")}
          </h3>
          <p className="text-sm sm:text-base text-text-secondary mb-4 sm:mb-6 max-w-md mx-auto px-2">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base hover:from-emerald-600 hover:to-teal-600 transition-all shadow-sm hover:shadow-md"
          >
    ...
    <section className="pt-0 pb-12 sm:pb-16 md:pb-20 lg:pb-28 bg-bg-secondary relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] sm:w-[600px] md:w-[750px] lg:w-[900px] h-[400px] sm:h-[600px] md:h-[750px] lg:h-[900px] bg-emerald-500/5 rounded-full blur-3xl" 
        />
      </div>
        ...
        >
          ...
          <div className="relative p-6 sm:p-8 md:p-10 lg:p-14 xl:p-20 text-center">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.3 }}
              className="text-base sm:text-lg md:text-xl text-white/80 mb-6 sm:mb-8 md:mb-10 max-w-xl sm:max-w-2xl mx-auto leading-relaxed px-2"
            >
            ...
            >
              <motion.a
                ...
                whileHover={{ scale: 1.02, y: -1 }}
                whileTap={{ scale: 0.98 }}
                className="group inline-flex items-center justify-center gap-2 px-5 sm:px-6 md:px-8 py-3 sm:py-3.5 md:py-4 bg-white text-emerald-600 rounded-lg sm:rounded-xl font-bold text-sm sm:text-base md:text-lg shadow-sm hover:shadow-lg transition-all"
              >
                <span>{t('cta.getStartedFree', 'Get Started Free')}</span>
                <Icon name="arrow-right" size="sm" className="icon-emerald group-hover:translate-x-0.5 transition-transform sm:hidden" />
                <Icon name="arrow-right" size="md" className="icon-emerald group-hover:translate-x-0.5 transition-transform hidden sm:block" />
              </motion.a>
              <motion.a
                href="#demo"
                whileHover={{ scale: 1.02, y: -1 }}
...
function Rewrite() {
  ...
  return (
    <>
      <PageSEO pageKey="rewrite" faqs={faqs} howToSteps={howItWorks} />
      ...
      <main className="relative" itemScope itemType="https://schema.org/WebPage">
        ...
        <section className="relative min-h-[85vh] sm:min-h-[88vh] lg:min-h-[92vh] flex items-center justify-center overflow-hidden pt-16 sm:pt-12 md:pt-8 pb-12 sm:pb-14 md:pb-16">
          ...
          <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 text-center relative z-10">
            ...
            >
              <motion.span 
                className="relative inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-emerald-500/10 via-emerald-500/15 to-green-500/10 text-emerald-600 dark:text-emerald-400 text-xs sm:text-sm font-semibold rounded-full border border-emerald-500/20 shadow-lg shadow-emerald-500/10"
                animate={{
                  boxShadow: [
            ...
            >
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative inline-flex items-center justify-center gap-2 px-5 sm:px-6 md:px-8 py-3 sm:py-3.5 md:py-4 bg-gradient-to-r from-emerald-500 to-green-500 text-white rounded-xl font-semibold text-sm sm:text-base overflow-hidden shadow-xl shadow-emerald-500/30"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
        ...
        <section className="py-12 sm:py-16 md:py-20 lg:py-28 relative">
          <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
            ...
            >
              ...
              {/* Demo Tips - Responsive */}
              <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm text-text-secondary px-2">
        ...
        {/* Related Features */}
        <RelatedFeatures currentFeature="rewrite" />
