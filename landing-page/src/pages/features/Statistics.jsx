/**
 * Statistics - Landing page for Text Statistics feature
 * Design: Data/Analytics Theme - "Understand Your Writing DNA"
 * Theme Color: Indigo/Purple - representing data, insights, and intelligence
 * Created: Dec 2025
 */
  ...
  return (
    ...
    >
      <div className="relative px-6 py-4 bg-white/60 dark:bg-white/5 backdrop-blur-sm rounded-2xl border border-white/50 dark:border-white/10 shadow-lg shadow-black/5">
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-xl" />
        
        <div className="text-center">
          <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">
            {displayValue}
          </div>
      ...
      <div className="max-w-content-lg mx-auto px-4 sm:px-6 relative">
        <div className="text-center mb-12">
          <motion.span 
            ...
            viewport={{ once: true }} 
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-sm font-semibold rounded-full mb-4 shadow-lg shadow-indigo-500/20"
          >
        ...
        <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-3xl border border-gray-100 dark:border-slate-700/50 p-6 md:p-8">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative w-56 h-56 mx-auto mb-6">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <motion.span 
                    ...
                    className={`text-5xl font-bold ${colorClasses[currentMetric.color].text}`}
                  >
                    {currentMetric.value}
                  </motion.span>
                  <span className="text-sm text-gray-500 dark:text-gray-400">{currentMetric.unit}</span>
                </div>
              </div>
              ...
              >
                <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full ${colorClasses[currentMetric.color].light}`}>
                  <Icon name={currentMetric.icon} size="sm" className={`icon-${currentMetric.color}`} />
                  <span className={`font-semibold ${colorClasses[currentMetric.color].text}`}>{currentMetric.title}</span>
                </div>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-3 max-w-sm mx-auto">{currentMetric.description}</p>
                ...
                <div className="mt-4 p-3 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
                  ...
                  <div className="relative h-2 bg-gray-200 dark:bg-slate-600 rounded-full">
                    <div 
                    ...
                    />
                    <div 
                      className="absolute w-3 h-3 bg-white border-2 border-current rounded-full -top-0.5 transform -translate-x-1/2"
                      style={{ 
                  ...
                  <div className="flex justify-center mt-2">
                    <span className={`text-xs font-medium ${colorClasses[currentMetric.color].text}`}>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-xl ${colorClasses[metric.color].light} flex items-center justify-center`}>
                        <Icon name={metric.icon} size="lg" className={`icon-${metric.color}`} />
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <span className={`font-semibold ${isActive ? colorClasses[metric.color].text : 'text-gray-800 dark:text-gray-200'}`}>{metric.title}</span>
                          <span className={`text-lg font-bold ${colorClasses[metric.color].text}`}>{metric.value}</span>
                        </div>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 line-clamp-1">{metric.description}</p>
                      </div>
                    </div>
                  </motion.button>
                )
      ...
      <div className="max-w-content-lg mx-auto px-4 sm:px-6">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 overflow-hidden shadow-lg"
          >
                  ...
                  {Object.entries(currentBenchmark).map(([key, value], index) => (
                    ...
                    >
                      <td className="px-6 py-4">
                        <span className="font-medium text-gray-800 dark:text-gray-200">{metricLabels[key]}</span>
                      </td>
                      <td className="px-6 py-4 text-center text-gray-600 dark:text-gray-400">{value.min}</td>
                      <td className="px-6 py-4 text-center">
                        <span className="inline-flex items-center justify-center w-16 py-1 bg-indigo-100 dark:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 font-bold rounded-lg">
                          {value.ideal}
                        </span>
                      </td>
                      <td className="px-6 py-4 text-center text-gray-600 dark:text-gray-400">{value.max}</td>
                      <td className="px-6 py-4">
        ...
        <motion.div
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="mt-6 p-4 bg-indigo-50 dark:bg-indigo-500/10 rounded-xl border border-indigo-100 dark:border-indigo-500/20"
        >
          <div className="flex items-start gap-3">
            <Icon name="info" size="sm" className="icon-indigo mt-0.5" />
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-12 left-full w-full h-0.5 bg-gradient-to-r from-indigo-300 to-transparent z-0" />
              )}
              ...
              <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-6 border border-gray-200 dark:border-slate-700 shadow-lg hover:shadow-xl transition-shadow">
                {/* Step number */}
                <div className="absolute -top-3 -left-3 w-8 h-8 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-lg">
                  {step.step}
                </div>
                
                <div className="w-14 h-14 bg-indigo-100 dark:bg-indigo-500/20 rounded-2xl flex items-center justify-center mb-4">
                  <Icon name={step.icon} size="xl" className="icon-indigo" />
                </div>
      ...
      <div className="max-w-content-lg mx-auto px-4 sm:px-6">
          ...
          {useCases.map((useCase, index) => (
            ...
            >
              <div className={`w-12 h-12 rounded-xl mb-4 flex items-center justify-center ${
                ...
                <Icon name={useCase.icon} size="lg" className={selectedCase === index ? 'icon-white' : 'icon-indigo'} />
              </div>
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            className="bg-gradient-to-br from-indigo-50 via-purple-50/50 to-white dark:from-slate-800 dark:via-indigo-900/20 dark:to-slate-900 rounded-3xl border border-indigo-200/50 dark:border-indigo-500/20 p-8"
          >
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-indigo-600 dark:text-indigo-400">{t('features.statistics.useCases.spotlight', 'Featured Use Case')}</p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {useCases[selectedCase].benefits?.map((benefit, i) => (
                    <span key={i} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-indigo-100 dark:bg-indigo-500/20 rounded-full text-sm text-indigo-700 dark:text-indigo-300 font-medium">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-gray-200 dark:border-slate-700 shadow-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('features.statistics.useCases.example', 'Example')}</span>
                </div>
...
const BenefitsSection = ({ t, benefits }) => {
  ...
  return (
    <section className="py-20 lg:py-28 bg-bg-secondary relative overflow-hidden">
      <div className="absolute top-1/3 left-0 w-72 h-72 bg-indigo-500/5 rounded-full blur-3xl" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {enhancedBenefits.map((benefit, index) => (
            <motion.div
              ...
              className="group relative bg-white dark:bg-slate-800 rounded-2xl p-6 border border-gray-200 dark:border-slate-700 shadow-lg hover:shadow-2xl hover:border-indigo-200 dark:hover:border-indigo-500/30 transition-all duration-300"
            >
              ...
              <div className="absolute -top-2 -right-2 w-7 h-7 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                {index + 1}
              </div>
              
              <div className="relative">
                <div className="w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center mb-4 shadow-lg shadow-indigo-500/20 group-hover:shadow-indigo-500/40 transition-shadow">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 relative">
        <div className="text-center mb-12">
          <motion.span 
            ...
            whileInView={{ opacity: 1, scale: 1 }} 
            viewport={{ once: true }} 
            className="inline-flex items-center gap-2 px-4 py-2 bg-bg-primary text-indigo-600 text-sm font-semibold rounded-full mb-4 border border-gray-200 dark:border-gray-700 shadow-sm"
          >
              ...
              >
                <div className="flex items-center gap-4 pr-4">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                    openFaq === index ? 'bg-gradient-to-br from-indigo-400 to-purple-500 text-white' : 'bg-bg-secondary text-indigo-600 group-hover:bg-indigo-500/10'
                  }`}>
                    <span className="text-sm font-bold">{String(index + 1).padStart(2, '0')}</span>
                  </div>
                  <span className={`text-base font-semibold transition-colors ${
                    openFaq === index ? 'text-indigo-600' : 'text-text-primary group-hover:text-indigo-600'
                  }`}>
                    {faq.q}
                  </span>
                </div>
                ...
                >
                  <Icon name="chevron-down" size="sm" className={openFaq === index ? 'text-indigo-600' : 'text-text-muted'} />
                </motion.div>
              </button>
        ...
        >
          <div className="w-16 h-16 mx-auto mb-4 bg-indigo-500/10 rounded-xl flex items-center justify-center">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-xl font-semibold hover:from-indigo-600 hover:to-purple-600 transition-all shadow-sm hover:shadow-md"
          >
    ...
    <section className="pt-0 pb-20 lg:pb-28 bg-bg-secondary relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] bg-indigo-500/5 rounded-full blur-3xl" 
        />
      </div>
...
function Statistics() {
  ...
  return (
    <>
      <SEOHead
        title={t('statistics.meta.title', 'Text Statistics - Analyze Your Writing Metrics | Graphos AI')}
        description={t('statistics.meta.description', 'Get comprehensive text statistics including readability scores, vocabulary richness, sentence analysis, and benchmark comparisons. Understand your writing DNA.')}
        keywords={['text statistics', 'writing analysis', 'readability score', 'vocabulary richness', 'sentence length', 'writing metrics', 'content analysis']}
      />
      <StructuredData
        type="SoftwareApplication"
        data={{
          name: 'Graphos Text Statistics',
          description: t('statistics.meta.description'),
          url: 'https://graphosai.com/features/statistics',
      ...
      <div className="relative">
        ...
        <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden pt-8 pb-16">
          ...
          <div className="max-w-content-lg mx-auto px-4 sm:px-6 text-center relative z-10">
            ...
            >
              <motion.span 
                className="relative inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-indigo-500/10 via-indigo-500/15 to-purple-500/10 text-indigo-600 dark:text-indigo-400 text-sm font-semibold rounded-full border border-indigo-500/20 shadow-lg shadow-indigo-500/10"
                animate={{
                  boxShadow: [
            ...
            >
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl font-semibold text-base overflow-hidden shadow-xl shadow-indigo-500/30"
